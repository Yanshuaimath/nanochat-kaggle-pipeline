...
parser.add_argument("--max-steps", type=int, default=None, help="optional cap on total optimizer steps") # this is added by Y.Q
...
if args.max_steps is not None:   #84-86 added by Y.Q
