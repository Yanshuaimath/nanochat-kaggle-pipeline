...
class Engine:
    ...
    def generate(self, tokens, num_samples=1, max_tokens=None, temperature=1.0, top_k=None, seed=42):
        ...
        # Keep KV cache dtype aligned with the repo-wide compute dtype used by the model.
        # This avoids dtype mismatches between queries and cached keys/values at inference time.
        dtype = COMPUTE_DTYPE
